    ...
    MaterialTheme {
        Surface(modifier = Modifier.fillMaxSize(), color = Color(0xFF0F172A)) {
            Column(modifier = Modifier.padding(20.dp).fillMaxSize(), verticalArrangement = Arrangement.spacedBy(16.dp)) {
                ...
                OutlinedTextField(value = home, onValueChange = { home = it }, label = { Text("Home Team") }, modifier = Modifier.fillMaxWidth())
                OutlinedTextField(value = away, onValueChange = { away = it }, label = { Text("Away Team") }, modifier = Modifier.fillMaxWidth())
